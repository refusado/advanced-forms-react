...
const birthdayErrorMap: { errorMap:
    z.ZodErrorMap } = {
  errorMap: () => {
...
export const singUpSchema = z.object({
  ...
  birthday: z.coerce.date(birthdayErrorMap)
    .max(yearsAgo18, { message: 'You must be at least 18 years old' }),
  password: z.string()
    .min(8, 'Password must be at least 8 characters'),
  confirmPassword: z.string(),
  animal: z.string()
    .refine(value => value == 'cat', 'Your favorite animal must be cat'),
  terms: z.boolean()
